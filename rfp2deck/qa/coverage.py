...
from rfp2deck.core.schemas import RFPUnderstanding, DeckPlan, TraceabilityReport, TraceabilityItem

def build_traceability_report(understanding: RFPUnderstanding, deck: DeckPlan) -> TraceabilityReport:
    ...
    for r in understanding.requirements:
        ...
        coverage.append(TraceabilityItem(
            requirement_id=r.id,
